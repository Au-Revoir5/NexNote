...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonVerticalPadding = screenHeight * 0.02;
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.fromLTRB(
                          horizontalPadding.clamp(20.0, 32.0),
                          screenHeight * 0.03,
                          horizontalPadding.clamp(20.0, 32.0),
                          screenHeight * 0.02,
                        ),
                      ...
                      // Card container for illustration and text
                      Container(
                        margin: EdgeInsets.symmetric(
                          horizontal: cardMargin.clamp(16.0, 24.0),
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                              height: (imageHeight + 80).clamp(180.0, 250.0),
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Column(
                                    children: [
                                      Container(
                                        height: imageHeight.clamp(140.0, 200.0),
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                padding: EdgeInsets.symmetric(
                                  vertical: buttonVerticalPadding.clamp(14.0, 18.0),
                                ),
